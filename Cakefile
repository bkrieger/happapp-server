...
dir = 
    ...
    server:
        ...
        gen: 'server/gen/'
    migration: 
        main_database: 'server/gen/scripts/database/main/migration.js'
        info_database: 'server/gen/scripts/database/data/migration.js'
...
migrate = () ->
    for m of dir.migration
        directory = dir.migration[m]
        process = spawn 'node', [directory]
